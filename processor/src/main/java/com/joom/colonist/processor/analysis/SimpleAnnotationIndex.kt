...
class SimpleAnnotationIndex(
  ...
  override fun findClassesWithAnnotation(annotationType: Type.Object): Collection<Type.Object> {
    return annotationTypeToTypeCollectionMap[annotationType] ?: emptyList()
  }
}
